...
import (
	"context"
	"github.com/FFFcomewhere/issue-example/common/ctxdata"
...
var ErrGenerateTokenError = xerr.NewErrMsg("generate token faild")
...
func (l *GenerateTokenLogic) GenerateToken(in *builder.GenerateTokenReq) (*builder.GenerateTokenResp, error) {
	now := time.Now().Unix()
	...
	return &builder.GenerateTokenResp{
